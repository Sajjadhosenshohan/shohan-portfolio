    ...
    return (
        <div >
            <div className="text-white flex gap-10 text-xl">
                ...
                <div className="flex justify-center items-center p-2 border-white border-2 hover:bg-[var(--accent)] duration-300 hover:border-[var(--accent)] cursor-pointer rounded-full">
